...
BugCatcherData:
; Viridian Forest
	db 6, PINSIR, KAKUNA, 0
	db 7, WEEDLE, KAKUNA, ODDISH, 0
	db 9, KAKUNA, 0
; Route 3
...
; Cerulean City
	...
	db $FF, 18, PIDGEOTTO, 15, NIDORAN_F, 15, RATTATA, 17, BULBASAUR, 0
	db $FF, 18, PIDGEOTTO, 15, NIDORAN_F, 15, RATTATA, 17, CHARMANDER, 0
...
Green2Data:
; SS Anne 2F
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, NIDORINA, 20, WARTORTLE, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, NIDORINA, 20, IVYSAUR, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, NIDORINA, 20, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 25, PIDGEOTTO, 23, NIDORINA, 22, EXEGGCUTE, 20, KADABRA, 25, WARTORTLE, 0
	db $FF, 25, PIDGEOTTO, 23, NIDORINA, 22, GROWLITHE, 20, KADABRA, 25, IVYSAUR, 0
	db $FF, 25, PIDGEOTTO, 23, NIDORINA, 22, GYARADOS, 20, KADABRA, 25, CHARMELEON, 0
; Silph Co. 7F
	db $FF, 37, PIDGEOT, 38, NIDORINA, 35, EXEGGCUTE, 35, ALAKAZAM, 40, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 38, NIDORINA, 35, GROWLITHE, 35, ALAKAZAM, 40, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 38, NIDORINA, 35, GYARADOS, 35, ALAKAZAM, 40, CHARIZARD, 0
; Route 22
	db $FF, 47, PIDGEOT, 45, NIDOQUEEN, 45, GROWLITHE, 47, EXEGGCUTE, 50, ALAKAZAM, 53, BLASTOISE, 0
	db $FF, 47, PIDGEOT, 45, NIDOQUEEN, 45, GYARADOS, 47, GROWLITHE, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 45, NIDOQUEEN, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, CHARIZARD, 0

Green3Data:
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, NIDOQUEEN, 61, ARCANINE, 63, EXEGGUTOR, 65, BLASTOISE, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, NIDOQUEEN, 61, GYARADOS, 63, ARCANINE, 65, VENUSAUR, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, NIDOQUEEN, 61, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, 0
